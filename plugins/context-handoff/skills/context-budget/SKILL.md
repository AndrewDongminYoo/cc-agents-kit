...
metadata:
  ...
  origin: https://github.com/affaan-m/ecc (MIT), skills/context-budget — largely upstream; see CREDITS.md
---
...
Context model: <active session model> (<its context window>)   # detect, don't assume
...
- **Deferred MCP loading (this setup)**: this harness defers MCP tool schemas via ToolSearch, so per-tool schema cost applies only to eagerly-loaded servers — weigh the skills/agents listings and the CLAUDE.md chain higher here

## Provenance

Vendored from [affaan-m/ecc](https://github.com/affaan-m/ecc) (MIT) on 2026-07-17; maintained locally since — added the deferred-MCP caveat for this harness.
